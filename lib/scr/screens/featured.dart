...
class FeaturedScreen extends StatelessWidget {
  final RestaurantModel featuredModel;

  const FeaturedScreen({Key key, this.featuredModel}) : super(key: key);
                ...
                borderRadius: BorderRadius.only(
                  ...
                  Positioned.fill(
                      ...
                      child: Align(
                          ...
                          child: CustomText(text: featuredModel.name, color: white, size: 26, weight: FontWeight.w300,))),
                  ...
                  Positioned.fill(
                      ...
                      child: Align(
                          alignment: Alignment.bottomCenter,
                          child: CustomText(text: "Average Price: \$" + featuredModel.avgPrice.toString(), color: white, size: 18, weight: FontWeight.w300,))),
...
//              open & book section
              ...
              // products
              Column(
                children: featuredProvider.featuredByRestaurant
